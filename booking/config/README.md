...
The authenticated owner portal imports that configuration once and stores it
encrypted in the installation's persistent data volume. The imported client ID
...
precedence when supplied. Keep the original downloaded private file outside this
directory and outside Git.
